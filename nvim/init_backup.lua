...
startup(function(use)
	...
	use("rhysd/vim-grammarous") -- " GrammarousCheck
	-- use("dpelle/vim-LanguageTool") -- " grammar
	-- use("vigoux/LanguageTool.nvim") -- grammar
...
-- undotree
map("n", "<leader>uu", "<cmd>:UndotreeToggle<cr>", options)
...
local path_to_elixirls = vim.fn.expand("~/.elixir-ls/release20.0/language_server.sh")
...
-- "<cmd>:cd /Users/klemenslukaszczyk/Documents/BI-Reporting-Backend-Elixir<cr><cmd>:pwd<cr>",
-- change dir
map("n", "<leader>cd", "<cmd>:cd %:p:h<cr><cmd>:pwd<cr>", options)
map("n", "<leader>gd", "<cmd>:cd /Users/klemenslukaszczyk/Documents/ecert_main<cr><cmd>:pwd<cr>", options)
